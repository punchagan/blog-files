...
TMP_DIR = os.path.join(ROOT_PATH, 'blog_tmp')

DEPLOY_DIR = os.path.join(PUB_PATH, 'blog')

BACKUPS_DIR = os.path.join(ROOT_PATH, 'backups')
BACKUP = False

SITE_ROOT = "/blog/"
SITE_WWW_URL = "http://punchagan.muse-amuse.in/"
SITE_NAME = "Rustic Reverie"
SITE_AUTHOR = "punchagan"
...
LISTING_PAGE_NAMES = ['listing', 'default', 'index']
